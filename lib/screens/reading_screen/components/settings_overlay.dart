...
class SettingsOverlayView extends StatefulWidget {
  final void Function()? onClose;
  const SettingsOverlayView({super.key, this.onClose});

  @override
  State<SettingsOverlayView> createState() => _SettingsOverlayViewState();
}

class _SettingsOverlayViewState extends State<SettingsOverlayView> {
  String volume = 'Volume 1';
  String book = 'Book 1';
  String hadith = 'Hadith 1';
